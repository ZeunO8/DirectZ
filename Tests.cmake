...
function(add_dz_test TEST_NAME TEST_SRC)
    ...
    target_include_directories(${TEST_NAME} PRIVATE ${DIRECTZ_INCLUDE_DIRS} ${munit_SOURCE_DIR})
    target_link_libraries(${TEST_NAME} PRIVATE DirectZ munit)
...
# add_dz_test(DZ_arena tests/arena.cpp)
