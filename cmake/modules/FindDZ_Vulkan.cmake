    ...
    foreach(dependent_component IN LISTS _ARG_DEPENDENT_COMPONENTS)
        if(NOT Vulkan_${dependent_component}_FOUND)
            set(all_dependent_component_found FALSE)
                message(STATUS "vulkan library component not found: ${dependent_component}, breaking foreach loop")
            break()
        else()
                message(STATUS "vulkan library component found: ${dependent_component}")
        endif()
    endforeach()
